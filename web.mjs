...
;
	($.$hack_app) = class $hack_app extends ($.$mol_book2_catalog) {
		Telegram(){
			const obj = new this.$.$mol_link_iconed();
			(obj.uri) = () => ("https://t.me/h_y_o_o/1074");
			(obj.title) = () => (null);
			return obj;
		}
		GitHub(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/Lyumih/hack");
			return obj;
		}
		About_text(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("# Рады с вами познакомиться!\nКоманда [Hyper Dev Guild](https://t.me/h_y_o_o/1074) собрала информацию по хакатонам\nОна будет полезна как для новичков, так и для тех кто уже съел собаку на них.\nМы постарались ответить на основные вопросы и дать инструкции на основные этапы хакатонов.\nА также сократить время на рутину и менеджмент, которая тратится во время хакатонов\n# Разделы\n- **[Первый Хакатон](#!page=first)** - полезен для новичков. В нём собрано описание, что такое хакатон\n- **[Презентация и Дизайн](#!page=pres_design)** - рассказываем, что как сделать презентацию и дизайн\n- **[Старт проекта](#!page=start)** - быстрый старт по технологиям для бэка и фронта, если не знаете что выбрать\n- **[Примеры решений](#!page=examples)** - поделитесь вашими решениями уже с готовых хакатонов\n\n# О нас\n[Hyper Dev Guild](https://t.me/h_y_o_o/1074) - Сообщество гипер-разработчиков, двигающих индустрию вперёд.\n*Будем рады видеть вас в наших рядах!*\nМы развиваем Open Source технологии на основе:\n- веб-фреймворка [$mol](https://mol.hyoo.ru/) (https://github.com/hyoo-ru/crowd.hyoo.ru/)\n- и оффлайн децентрализованной базе данных [crowd](https://crowd.hyoo.ru/) (https://github.com/hyoo-ru/crowd.hyoo.ru/)");
			return obj;
		}
		About_page(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Знакомство");
			(obj.body) = () => ([(this.About_text())]);
			return obj;
		}
		What_is(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Что такое хакатон");
			return obj;
		}
		Dict(){
			const obj = new this.$.$mol_page();
		...
		Presentation(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Презентация Google");
			return obj;
		}
		Design(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Дизайн Figma");
			return obj;
		}
		Diagram(){
			const obj = new this.$.$mol_page();
		...
		Pres_design(){
			const obj = new this.$.$mol_book2_catalog();
			(obj.menu_title) = () => ("Презентация и Дизайн");
			(obj.param) = () => ("design");
			(obj.spreads) = () => ({
		...
		Dosha(){
			const obj = new this.$.$mol_link();
			(obj.title) = () => ("\"Добрый шаг\" - Кокос 2023г");
			(obj.uri) = () => ("https://lyumih.github.io/dosha/");
			return obj;
		}
		VTB24(){
			const obj = new this.$.$mol_link();
			(obj.title) = () => ("\"Money Card Hero\" - ВТБ24 хакатон 2023г");
			(obj.uri) = () => ("https://lyumih.github.io/money/");
			return obj;
		}
		Examples_page(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Примеры решений");
			(obj.body) = () => ([(this.Dosha()), (this.VTB24())]);
			return obj;
		}
		menu_title(){
			return "Хакатоны Hyper Dev Guild";
		}
		param(){
			return "page";
		}
		...
		spreads(){
			return {
				...
				"pres_design": (this.Pres_design()), 
				"start": (this.Start_page()), 
				"examples": (this.Examples_page())
			};
		}
	};
	($mol_mem(($.$hack_app.prototype), "Telegram"));
	($mol_mem(($.$hack_app.prototype), "GitHub"));
	($mol_mem(($.$hack_app.prototype), "About_text"));
	($mol_mem(($.$hack_app.prototype), "About_page"));
	($mol_mem(($.$hack_app.prototype), "What_is"));
	($mol_mem(($.$hack_app.prototype), "Dict"));
	($mol_mem(($.$hack_app.prototype), "Roles"));
	($mol_mem(($.$hack_app.prototype), "Myths"));
	($mol_mem(($.$hack_app.prototype), "First_page"));
	($mol_mem(($.$hack_app.prototype), "Presentation"));
	($mol_mem(($.$hack_app.prototype), "Design"));
	($mol_mem(($.$hack_app.prototype), "Diagram"));
	($mol_mem(($.$hack_app.prototype), "Pres_design"));
	($mol_mem(($.$hack_app.prototype), "Front"));
	($mol_mem(($.$hack_app.prototype), "Back"));
	($mol_mem(($.$hack_app.prototype), "Bd"));
	($mol_mem(($.$hack_app.prototype), "Hosting"));
	($mol_mem(($.$hack_app.prototype), "Start_page"));
	($mol_mem(($.$hack_app.prototype), "Dosha"));
	($mol_mem(($.$hack_app.prototype), "VTB24"));
	($mol_mem(($.$hack_app.prototype), "Examples_page"));
