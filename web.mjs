...
var $;
(function ($) {
    class $hack_app extends $mol_book2_catalog {
        menu_title() {
    ...
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Telegram", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "GitHub", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "About_text", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "About_page", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "What_is", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Dict", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Roles", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Myths", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "First_page", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Presentation", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Design", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Diagram", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Pres_design", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Front", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Back", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Bd", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Hosting", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Start_page", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Dosha", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "VTB24", null);
    __decorate([
        $mol_mem
    ], $hack_app.prototype, "Examples_page", null);
    $.$hack_app = $hack_app;
})($ || ($ = {}));
//hack/app/-view.tree/app.view.tree.ts
;
"use strict";
var $;
(function ($) {
